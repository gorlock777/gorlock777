...
<!-- Contribution Snake eating the GitHub heatmap dots -->
<div align="center">
  <picture>
...
const gorlock777 = {
  pronouns: "he/him",
  code: [JavaScript, TypeScript, Python, Cpp, Rust],
  technologies: {
    frontEnd: { js: ["React", "Next.js", "TailwindCSS", "HTML5/CSS3"] },
    backEnd: { js: ["Node.js", "Express", "FastAPI", "PostgreSQL", "MongoDB"] },
    devOps: ["Docker", "Git", "GitHub Actions", "Linux"]
  },
  currentFocus: "Architecting scalable systems & high-performance applications",
  hobbies: ["Coding 💻", "Gaming 🎮", "Open Source 🌐", "Problem Solving 🧩"],
  funFact: "My commits turn into snacks for the snake above!"
};
```
